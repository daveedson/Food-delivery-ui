        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            Positioned(
              bottom: 10.0,
              right:10.0,
              child:  Container( //add cirle button
           width: 48.0,
           decoration: BoxDecoration(
            ...
            padding: EdgeInsets.all(15.0),
                    ...
                    children: <Widget>[
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Text(widget.restaurant.name,style: TextStyle(fontWeight: FontWeight.w700,fontSize: 23.0),),
                            Text('1 mile away',style: TextStyle(fontSize: 18.0),),
                          ],
                          ...
                          SizedBox(height: 6.0,),
                          Text(
                            widget.restaurant.address,style: TextStyle(fontWeight: FontWeight.w500),
                            ),
                    ],
                    ),
                    ),
